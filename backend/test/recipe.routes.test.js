...
describe('Recipe Routes Integration Tests', () => {
    ...
    describe('GET /api/v1/recipes', () => {
        ...
        it('should handle query parameters', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield (0, supertest_1.default)(app_1.default)
                ...
                .expect(200);
            expect(mockClient.query).toHaveBeenCalledWith('SELECT * FROM recipes WHERE type = ANY($3) ORDER BY add_date LIMIT $1 OFFSET $2', [5, 10, ['dessert']]);
        }));
    });
    describe('POST /api/v1/recipes', () => {
        it('should create a new recipe', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const createdRecipe = Object.assign(Object.assign({}, newRecipe), { id: 1 });
    ...
    describe('PUT /api/v1/recipes/:id', () => {
        it('should update a recipe', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('DELETE /api/v1/recipes/:id', () => {
        it('should delete a recipe', () => __awaiter(void 0, void 0, void 0, function* () {
