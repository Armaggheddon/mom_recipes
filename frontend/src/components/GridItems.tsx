...
export default function GridItems({ recipes, onItemClick, onNewRecipeClick = () => { } }: GridItemsProps) {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-2 pb-8">
			{
				recipes.length === 0 ? (
					<div className="col-span-full flex items-center justify-center min-h-[200px]">
						<div className="flex flex-col items-center">
							<p className="text-on-background">🔍 It looks like you haven't added any recipes yet.</p>
