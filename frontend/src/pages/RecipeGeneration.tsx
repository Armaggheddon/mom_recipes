...
export default function RecipeGeneration({ status, errorMessage }: RecipeGenerationProps) {
	...
	const [currentDescription, setCurrentDescription] = useState<string>(progressSteps[0]);
